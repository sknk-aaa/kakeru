...
export default function BottomNav() {
  ...
  return (
    <nav
      ...
      style={{ left: "max(0px, calc(50vw - 240px))", width: "min(100vw, 480px)", paddingBottom: "calc(env(safe-area-inset-bottom) + 12px)", overflow: "visible", boxShadow: "0 -8px 28px rgba(0,0,0,0.05)" }}
    >
