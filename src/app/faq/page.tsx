...
const FAQ_CATEGORIES = [
  {
    ...
    items: [
      {
        q: "本当に課金されるの？",
        a: "はい。設定した目標を当日23:59までに達成しなかった場合、設定した罰金額が自動で引き落とされます。\n\n逆に言えば、目標を達成すれば一切課金されません。",
      },
      {
        q: "どのように課金されるの？",
        a: "目標を設定する際に、決済サービス「Stripe」を通じてクレジットカードを登録していただきます。\n\n罰金が発生した場合は毎日 23:59 に自動で引き落とされます。登録後の操作は不要で、達成していれば課金されません。",
      },
      {
        q: "クレカ情報は安全？",
      ...
      {
        q: "走れば無料ってどういうこと？",
        a: "カケルは「達成したら課金なし、サボったら課金」という仕組みです。\n\n走っていれば費用はかかりません。課金されるのはサボった日だけです。",
      },
      {
        q: "いきなり高額請求されない？",
        a: "されません。課金は「1日の未達成につき、設定した罰金額」だけです。\n\nたとえば罰金500円に設定した場合、1日サボっても500円のみ。まとめて請求されることはありません。",
      },
      {
        q: "罰金はいつ引き落とされますか？",
        a: "毎日 23:59（日本時間）に当日の目標達成状況を確認し、未達成の場合に自動で課金されます。\n\n23 時台でも、計測を終了して記録が保存されていれば達成として判定されます。",
      },
      {
        q: "課金されたお金はどうなりますか？",
        a: "カケルのサービス運営・機能改善のために使用されます。",
      },
    ],
  },
  {
    ...
    items: [
      {
        q: "アプリ版はないの？",
        a: "専用アプリのインストールは不要です。ホーム画面に追加することで、アプリと同じように使えます。",
      },
      {
        q: "ホーム画面に追加する方法は？",
        a: "【iPhone の場合】\nSafari でカケルを開き、画面下部の共有ボタンをタップ →「ホーム画面に追加」を選択してください。\n\n【Android の場合】\nChrome でカケルを開き、右上のメニュー（⋮）をタップ →「アプリをインストール」または「ホーム画面に追加」を選択してください。",
      },
      {
        q: "目標スキップは何回使えますか？",
      ...
      {
        q: "目標を一時的に止めたいです",
        a: "目標の編集ページ下部にある「この目標を停止する」から停止できます。翌日以降のスケジュールがキャンセルされ、課金も発生しなくなります。\n\nなお、「面倒だから取り消そう」ができないように、当日中の取り消しはできない仕様になっています。もし当日中にやむを得ず取り消す必要がある場合は、お問い合わせフォームからご連絡ください。",
      },
      {
        q: "複数の目標を同時に設定できますか？",
